...
body {
    ...
    font-family: 'Staatliches', cursive;
  	...
  	background: -webkit-linear-gradient(to right, #fffc00, #ffffff); /* Chrome 10-25, Safari 5.1-6 */
  	background: linear-gradient(to right, #fffc00, #ffffff); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
}
...
@-webkit-keyframes fadeInLeft {
 ...
 @keyframes fadeInLeft {
    ...
    <div id ="border" class = "fadeInLeft">
        ...
        <div class ="textbox">
        <textarea id="dets" name="QR_Input" type = "text" value = "1" rows = "1" cols= "33" placeholder="IBS Code"></textarea>
        </div>
...
function getRandomInt(min, max) {
  ...
  return Math.floor(Math.random() * (max - min) + min); //The maximum is exclusive and the minimum is inclusive
    ...
    function displayQrCodeInfo() {
        ...
        let ibsCode =getRandomInt(10000000000,90000000000); //grab the value of the textbox input
        let display = document.getElementById("output"); // grab the output div
       
        
       console.log("ibs", ibsCode)
      ...
      // Using https://davidshimjs.github.io/qrcodejs/
        let qrcode = new QRCode("output", {
            text: "http://scanme.greymatter.com.pk/send.html?user="+ibsCode,
            colorDark : "#000000",
            colorLight : "#ffffff"
...
<script >
  ...
  const firebaseConfig = {
    apiKey: "AIzaSyDHQBSc1sd6ulk0sAMTg3ssG4TTsihbxXY",
    authDomain: "scan-5b619.firebaseapp.com",
    databaseURL: "https://scan-5b619-default-rtdb.firebaseio.com",
    projectId: "scan-5b619",
    storageBucket: "scan-5b619.appspot.com",
    messagingSenderId: "12159344637",
    appId: "1:12159344637:web:dc75f4df4a0af74e850394"
  };

  // Initialize Firebase
firebase.initializeApp(firebaseConfig);
  var database = firebase.database();
  var starCountRef = firebase.database().ref('/meta');
    starCountRef.on('value', (snapshot) => {
      const data = snapshot.val();
     document.querySelector("#dets").innerHTML= data.name
     console.log(data)
    });
</script> 